        ...
        <div class="modal-content" style="display: block; overflow-y: auto; max-height: 90vh; padding: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="checkout-form">
                    ...
                    <textarea id="custAddress" placeholder="Full Delivery Address (Enter your complete address)" style="width:100%; padding:12px; margin-bottom:10px; border:1px solid #ddd; border-radius:8px; height:80px; resize:none;"></textarea>
